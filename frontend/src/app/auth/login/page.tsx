  ...
  return (
    <Card className="p-8">
      <div className="mb-8 text-center">
        <span className="mx-auto mb-3 grid size-14 place-items-center rounded-2xl bg-brand-yellow text-2xl font-black text-ink ink-border ink-shadow-sm">
          C
        </span>
        <h1 className="text-2xl font-black text-ink uppercase tracking-tight">Sign In</h1>
      ...
      <p className="mt-6 text-center text-xs font-bold text-muted tracking-wider">
        ...
        <Link href="/auth/signup" className="text-ink underline underline-offset-2 hover:text-brand-pink">
          Sign up
        </Link>
      </p>
    </Card>
