        ...
        <div className="relative bg-white rounded-sm border-[3.5px] border-black transform -rotate-[0.5deg] p-6 md:p-8 flex flex-col gap-6">
          <div className="flex items-center justify-between border-b-[3px] border-black pb-4 select-none">
            <h2 className="font-lilita text-2xl md:text-3xl tracking-wide uppercase flex items-center gap-2">
              <span>🛡️</span> OUR PRIVACY PLEDGE
            </h2>
            <Link
              href="/login"
          ...
          <div className="flex flex-col gap-5 text-xs md:text-sm font-sans font-semibold leading-relaxed text-black/85">
            <section className="flex flex-col gap-1.5">
              ...
              <p>
                We only collect your email address for authentication via secure passwordless OTP magic codes, along with the chat messages you send to your squadmates. No unnecessary tracking or sneaky background data hoarding.
              </p>
            </section>
            ...
            <section className="flex flex-col gap-1.5">
              ...
              <p>
                Your email address is strictly used to authenticate your session and notify you when friends invite you to join new conversation squads. We do not sell, rent, or trade your personal information to third parties.
              </p>
            </section>

            <section className="flex flex-col gap-1.5">
              <h3 className="font-lilita text-md md:text-lg text-black uppercase tracking-wider flex items-center gap-1.5">
                <span>3.</span> REAL-TIME SOCKET SECURITY
              </h3>
              <p>
                All live messaging and online status events are streamed over encrypted WebSocket connections. Chat messages are delivered straight to recipient squad members without external exposure.
              </p>
            </section>

            <section className="flex flex-col gap-1.5">
              <h3 className="font-lilita text-md md:text-lg text-black uppercase tracking-wider flex items-center gap-1.5">
                <span>4.</span> YOUR RIGHTS & CONTROL
              </h3>
              <p>
                You can change your username at any time directly in your profile settings. You also have full authority to request data deletion or account removal whenever you choose.
              </p>
            </section>
          </div>
          ...
          <div className="pt-4 border-t-[2.5px] border-black flex justify-between items-center select-none text-[10px] md:text-xs font-lilita uppercase text-black/60">
            <span>ZAP! CHAT PRIVACY ENGINE</span>
