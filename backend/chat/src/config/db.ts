...
const connectDB = async () => {
    ...
    if (primaryUri) {
        try {
            ...
            if (conn) {
                console.log("✅ Successfully connected to MongoDB in Chat Service");
                return;
            }
        } catch (error: any) {
    ...
    try {
        ...
        if (localConn) {
            console.log("✅ Successfully connected to local MongoDB (Docker/127.0.0.1:27017) in Chat Service");
        }
